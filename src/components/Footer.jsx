...
const Footer = () => {
  return (
    <footer className="bg-black py-8 dark:bg-slate-950">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          <div className="mb-4 w-full sm:w-1/2 md:w-1/4 lg:w-1/6">
            <h3 className="mb-4 text-lg font-bold text-white">Follow Me</h3>
          ...
          <div className="mb-4 w-full sm:w-1/2 md:w-1/4 lg:w-1/6">
            <h3 className="mb-4 text-lg font-bold text-white">Address</h3>
